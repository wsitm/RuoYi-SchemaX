...
public enum DialectEnum {
    ...
    Hive2Dialect(DRIVER_HIVE2, "Hive2Dialect", com.ruoyi.rdbms.dialects.Hive2Dialect.DIALECT),
    ClickHouseDialect(DRIVER_CLICK_HOUSE, "ClickHouseDialect", com.ruoyi.rdbms.dialects.ClickHouseDialect.DIALECT),
