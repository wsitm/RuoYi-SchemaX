package com.ruoyi.schemax.metainfo.impl;
...
import com.ruoyi.schemax.entity.vo.IndexVO;
import com.ruoyi.schemax.entity.vo.TableVO;
import com.ruoyi.schemax.metainfo.AbsMetaInfoHandler;
import com.ruoyi.schemax.metainfo.anno.JdbcType;
...
public class OracleMetaInfoHandler extends AbsMetaInfoHandler {
     ...
     */
    @Override
    public void flushData(Long connectId, Function<String, Boolean> checkNameFunc, Consumer<TableVO> consumer) {
        try (
