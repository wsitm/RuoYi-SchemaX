  ...
  methods: {
    ...
    handleLoad(row) {
      ...
      loadJdbc(jdbcId, action).then(response => {
        this.$modal.msgSuccess((row.isLoaded ? '卸载' : '安装') + "成功");
        this.getList();
      });
    },
