    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
            ...
            :disabled="multiple"
            @click="handleDelete"
            v-hasPermi="['rdbms:connect:remove']"
        >删除
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
            ...
            size="mini"
            @click="handleExport"
            v-hasPermi="['rdbms:connect:export']"
        >导出
        </el-button>
      </el-col>
      ...
      <el-table-column label="操作" align="center" fixed="right"
        ...
        <template slot-scope="scope">
          ...
          <el-dropdown size="mini"
                       ...
                       v-hasPermi="['rdbms:connect:info-export', 'rdbms:connect:edit', 'rdbms:connect:remove']">
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-tooltip content="导出当前连接库的表结构信息" placement="left">
                <el-dropdown-item icon="el-icon-download"
                                  command="handleConnectExport"
                                  v-hasPermi="['rdbms:connect:info-export']">导出
                </el-dropdown-item>
              </el-tooltip>
              <el-dropdown-item icon="el-icon-edit"
                                command="handleConnectEdit"
                                v-hasPermi="['rdbms:connect:edit']">修改
              </el-dropdown-item>
              <el-dropdown-item icon="el-icon-delete"
                                command="handleConnectRemove"
                                v-hasPermi="['rdbms:connect:remove']">删除
              </el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </template>
